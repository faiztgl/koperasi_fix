...
}else
{
  ...
  switch($pilih){
    ...
    case "5.1"  : $tampil = "shu/index.php"; break;
    case "5.2"  : $tampil = "tutupbuku/tutupbuku.php"; break;
      ...
      <head>
        ...
        <link rel="shortcut icon" href="kopindo.png" />
    ...
    <body>
      ...
      *********************************************************************************************************************************************************** -->
      ...
      {
        echo '<header class="header" style="background-color:#FFA500;">';
      }
        ...
        <div id="sidebar"  class="nav-collapse ">
          ...
          if($_SESSION['level']=='admin')
          {
            ...
            <ul class="sidebar-menu" id="nav-accordion">
              <p class="centered"><a href="#"><img src="kopindo.png"  width="100"></a></p>
             ...
             <li class="sub-menu">
              <a href="index.php?pilih=5.1">
                <i class="fa fa-dollar"></i>
                <span style="font-size:120%; color:#fff;">SHU</span>
              </a>
            </li>

             <li class="sub-menu">
              <a href="index.php?pilih=5.2">
                <i class="glyphicon glyphicon-book"></i>
                <span style="font-size:120%; color:#fff;">Tutup Buku</span>
              </a>
            </li>
                 <!--  <li class="sub-menu">
                ...
                else if($_SESSION['level']=='operator')
                {
                  ?>
                  <ul class="sidebar-menu" id="nav-accordion">
                    <p class="centered"><a href="#"><img src="kopindo.png" class="img-circle" width="60"></a></p>
                    <h5 class="centered"><?php echo $_SESSION['kopname'];?></h5>
                ...
                ?>
                <hr>
                <center>Copyright &copy; Pemuda Garis Santuy | Distributed by <a href="https://blogodud.com" target="_blank" rel="noopener noreferrer">Logodud</a>
                </center>
                <!-- sidebar menu end-->
              </div>
            </aside>
