 ...
 <script type="text/javascript" src="/md5.js"></script>
   <div class="container" id="login-block">
        <div class="row">
          <div class="col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4">
            ...
            <div class="login-logo">
                  <a href="#"><img class="img-responsive" src="../kopindo.png" width="150" height="150" alt="Company Logo" /></a>
                </div> 
                <hr />
      ...
      <footer class="container">
        <p id="footer-text">Copyright &copy; Pemuda Garis Santuy | Distributed by <a href="https://blogodud.com" target="_blank" rel="noopener noreferrer">Logodud</a></p>
      </footer>
